...
import { PortfolioSearch } from '@/interfaces/interface.invest.strategy';

export default function PortfolioSearchTable({ searchFunc }: { searchFunc: (data: PortfolioSearch) => void }) {
